...
class Trainer(object):
    ...
    def train(self):
        ...
        self.model_path = os.path.join(self.params['model_dir'] + 'seq2seq/')
        self.result_path = os.path.join(self.params['result_dir'] + 'seq2seq/')
        self.summary_path = os.path.join(self.params['summary_dir'] + 'seq2seq/')

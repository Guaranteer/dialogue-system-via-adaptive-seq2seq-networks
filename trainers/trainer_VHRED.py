...
from data_loader_HANL import Batcher
from model_VHRED import Model
import time
...
class Trainer(object):
    ...
    def train(self):
        ...
        self.model_path = os.path.join(self.params['model_dir'] + 'VHRED/')
        self.result_path = os.path.join(self.params['result_dir'] + 'VHRED/')
        self.summary_path = os.path.join(self.params['summary_dir'] + 'VHRED/')
...
if __name__ == '__main__':
    config_file = '../configs/configs_base.json'

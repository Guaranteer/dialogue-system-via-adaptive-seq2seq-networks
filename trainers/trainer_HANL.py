...
class Trainer(object):
    ...
    def train(self):
        ...
        self.model_path = os.path.join(self.params['model_dir'] + 'base_plus/')
        self.result_path = os.path.join(self.params['result_dir'] + 'base_plus/')
        self.summary_path = os.path.join(self.params['summary_dir'] + 'base_plus/')

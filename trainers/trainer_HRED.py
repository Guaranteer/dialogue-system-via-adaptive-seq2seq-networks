...
class Trainer(object):
    ...
    def train(self):
        ...
        self.model_path = os.path.join(self.params['model_dir'] + 'HRED/')
        self.result_path = os.path.join(self.params['result_dir'] + 'HRED/')
        self.summary_path = os.path.join(self.params['summary_dir'] + 'HRED/')
